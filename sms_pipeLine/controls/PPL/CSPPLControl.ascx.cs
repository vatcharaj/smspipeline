...
{
    public partial class CSPPLControl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                Grid_ppl.DataSource = ViewState["CurrentCSPPL"] as DataTable;
                Grid_ppl.DataBind();
            }
        }
        public void BindPPLDetail(string group_id, int level)
        {
            ...
            DataTable dtppl = cc2.LoadCSPPL(group_id);
          //  dtppl = findPTTPerson(dtppl, group_id);
            ViewState["CurrentCSPPL"] = dtppl;
        ...
        protected void Grid_ppl_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            Grid_ppl.DataBind();
            ViewState["CurrentCSPPL"] = Grid_ppl.DataSource as DataTable;
        } 
        ...
        protected void Grid_ppl_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "DelPPL")
            {
                ...
                DataTable dtgroup = ViewState["CurrentCSGrp"] as DataTable;
                DataTable dtppl = ViewState["CurrentCSPPL"] as DataTable;
               ...
               // string text = TreeView1.SelectedNode.Text;
                ...
                cc2.DeleteCSPPL(group_id, d, person_id);
        ...
        protected void Grid_ppl_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            ViewState["CurrentCSPPL"] = view.ToTable();
        }
        ...
        public string CountPPL()
        {
            ...
            if (ViewState["CurrentCSPPL"] != null)
                dt = ViewState["CurrentCSPPL"] as DataTable;
