<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GCPPLControl.ascx.cs" Inherits="sms_pipeLine.controls.GCPPLControl" %>
...
<asp:Panel ID="grpPanel" CssClass="dimmer"  runat="server" Visible="false"></asp:Panel>
   ...
   <tr style="visibility:hidden">
      ...
      <td align="right">
       ...
       <td align="right">
       บริษัท : </td>
       <td><asp:Label ID="unitnameLabel" runat="server" Text=""></asp:Label>
       <asp:Label ID="CompanyIDLabel" runat="server" Text="" Visible="false"></asp:Label>
       </td>
       </tr>
       <tr>
