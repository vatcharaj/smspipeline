<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PTTBPPLControl.ascx.cs" Inherits="sms_pipeLine.controls.PPL.PTTBPPLControl" %>
...
<asp:Panel ID="grpPanel" CssClass="dimmer"  runat="server" Visible="false"></asp:Panel>
   ...
   <tr style="visibility:hidden">
      ...
      <td><asp:Label ID="poscodeLabel" runat="server" Text=""></asp:Label></td>
      </tr>
      <tr>
      <td align="right">
       ชื่อ : </td>
