<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TCSControl.ascx.cs" Inherits="sms_pipeLine.controls.TCSControl" %>
 <asp:UpdatePanel ID="GROUP_PANEL" runat="server" Visible="false"  style="max-height:450px; overflow:auto" >
    <ContentTemplate>
      <asp:GridView ID="Grid_group" runat="server" 
      CssClass="GRIDDETAIL" OnSorting="Grid_group_Sorting"
       AllowSorting="true"
