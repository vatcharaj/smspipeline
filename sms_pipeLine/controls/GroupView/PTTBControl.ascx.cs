...
{
    public partial class PTTBControl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                Grid_group.DataSource = ViewState["CurrentPTTBroadGrp"] as DataTable;
                Grid_group.DataBind();
            }
        ...
        public void BindGroupDetail(string group_id, int level)
        {
            ...
            ViewState["CurrentPTTBroadGrp"] = dtgroup;
