<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TCSPPLEditControl.ascx.cs" Inherits="sms_pipeLine.controls.TCSPPLEditControl" %>
<asp:UpdatePanel ID="PPL_PANEL" runat="server" Visible="false"  >
      <ContentTemplate>
      <h6> รายชื่อบุคคลในกลุ่ม ทล.ตสก </h6>
        <div>
 ...
 <asp:Button ID="AddpplBtn" runat="server" CssClass=" btn btn-default btn-small"  style="float:right; margin-right:10px"
                    Text="เพิ่มบุคคล" onclick="AddpplBtn_Click" Visible="false" />
       </div>
<hr />
