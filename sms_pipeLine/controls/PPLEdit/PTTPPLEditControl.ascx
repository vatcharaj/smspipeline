<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PTTPPLEditControl.ascx.cs" Inherits="sms_pipeLine.controls.PPLEdit.PTTPPLEditControl" %>
<asp:UpdatePanel ID="PPL_PANEL" runat="server" Visible="false"  >
      <ContentTemplate>
         <h6> รายชื่อบุคคลในกลุ่ม ปตท. </h6>
       <div>
   ค้นหา :     
        ...
        <asp:BoundField  HeaderText="ID" DataField="EMPLOYEE_ID" SortExpression="EMPLOYEE_ID"   />  
          <asp:BoundField  HeaderText="NAME" DataField="NAME"  SortExpression="NAME"  /> 
           <asp:BoundField  HeaderText="POSITION" DataField="POSITION"  SortExpression="POSITION"    /> 
            <asp:BoundField  HeaderText="UNIT" DataField="COMPANY" SortExpression="COMPANY" ItemStyle-Font-Size="10px"    />
            <asp:BoundField  HeaderText="MOBILE" DataField="MOBILE"     />
              <asp:BoundField  HeaderText="LASTUPDATE" DataField="LASTUPDATE" SortExpression="LASTUPDATE" ItemStyle-Font-Size="10px" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" HtmlEncode="false"   />
            <asp:BoundField  HeaderText="BY" DataField="UPDATE_BY"   SortExpression="UPDATE_BY" ItemStyle-Font-Size="11px"   />
